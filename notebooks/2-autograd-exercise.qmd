...
The autograd function therefore does not calculate the gradient of $g$ with respect to $x$, but the gradient of the final node of the autograd graph with respect to $x$.
