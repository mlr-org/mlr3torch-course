...
A `lazy_tensor` column is built upon `torch::dataset` class that we have seen earlier.
...
Just like earlier, we need to define the tuner, search search space, resampling strategy, tuning measure and our budget.
