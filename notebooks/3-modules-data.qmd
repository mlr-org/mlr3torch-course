...
While neural networks with a single hidden layer can theoretically approximate any continuous function, the practical challenge lies in finding these solutions efficiently.
...
![[Source](https://www.ibm.com/think/topics/convolutional-neural-networks)](../assets/convolution.png)
...
![[Source](https://medium.com/@ramendrakumar/self-attention-d8196b9e9143)](../assets/attention.png)
...
![[Source](https://data-science-blog.com/blog/2021/04/07/multi-head-attention-mechanism/)](../assets/attention2.png){width=60%}
...
![[Source](https://scikit-learn.org/1.5/modules/neural_networks_supervised.html)](../assets/mlp-layer.png){width=40%}
...
![[Source](https://tikz.net/neural_networks/)](../assets/neural_networks-002.png){width=60%}
...
Two central classes are `dataset` and `dataloader`, which address separate concerns:
