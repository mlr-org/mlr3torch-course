...
While the intervals are too wide to be able to draw any final conclusions and we are only looking at a single dataset, both normalization techniques tend to lead to better results.
...
x = bmr$score()[, c("learner_id", "iteration", "classif.ce")]
```
