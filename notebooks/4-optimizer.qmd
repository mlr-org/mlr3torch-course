...
While the intervals are too wide to be able to draw any final conclusions, dropout here seems to have the biggest positive effect on the generalization performance of the model.
