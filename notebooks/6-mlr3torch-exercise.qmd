...
Then, resample the learner on the task with a cross-validation with 10 folds and evaluate the results using classification error and false positive rate (FPR).
Is the result good?
