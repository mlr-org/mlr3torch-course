...
As an example for two compatible matrices, we can generate two random matrices with shape `(10, 5)` and `(5, 10)`.
...
Implement a new version of this function that returns the same tensor but does not change the value of the input tensor in-place.
