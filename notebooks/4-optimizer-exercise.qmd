...
For the momentum parameter, we can observe that too large values for the momentum parameter lead to oscillations, possibly because the local information is not used enough.
